...
it pass. Only test files named in the failures above may be edited at all; any other test file is frozen and changing one fails the run. Re-run the failing command yourself to confirm the fix before you finish.
