...
- Pause is honoured between graph nodes (an agent turn is one CLI call and cannot
  be interrupted mid-flight); resume releases the same run rather than restarting it.
